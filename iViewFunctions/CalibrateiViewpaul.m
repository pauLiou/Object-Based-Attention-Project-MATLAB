...
% User instructions
message = sprintf('Please follow the red dot on the screen with your eyes! \nDo not try to close your eyes or blink.');

f = figure('Name', 'Calibration Instruction', ...
    'NumberTitle', 'off', ...
    'Color', bkgd, ...
...
if(ret_setCal == 1)
    ...
    %check whether the calibration worked
    if (ret_cal == 1)
